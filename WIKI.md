...
| --- | --- | --- |
| Statement of Work | Not present in repository snapshot | Provide the latest PDF in the repository root so the delivery team can keep this wiki aligned with contractual scope. |
| Change Log | Not present in repository snapshot | Upload the authoritative change log PDF to ensure parity between engineering delivery and client sign-off. |
