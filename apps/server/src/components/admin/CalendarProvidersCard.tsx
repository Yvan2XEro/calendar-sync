...
import { useLinkOrgProviders } from "@/hooks/use-provider-admin";
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Link this calendar to one or more providers.
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				{providersQuery.isError ? (
					...
					<Alert>
						...
						<AlertDescription>
							Configure providers from the global settings to make them
							available here.
						</AlertDescription>
					</Alert>
				) : (
