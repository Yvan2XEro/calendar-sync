...
export function parseHeroMedia(value: unknown): EventHeroMedia {
	...
	const type =
		raw.type === "image" || raw.type === "video" ? raw.type : undefined;
...
export function hasLandingContent(
	content: EventLandingPageContent | null | undefined,
) {
