...
import { adminCalendarConnectionKeys } from "@/lib/query-keys/calendar-connections";
...
export default function AdminCalendarConnectionsPage() {
	...
	const connectionsQuery = useQuery({
		queryKey: adminCalendarConnectionKeys.list(selectedSlug ?? undefined),
		queryFn: () => {
			if (!selectedSlug) {
...
>>>>>>> 23fa5ef (fix(calendar): associate connections with users)
}
