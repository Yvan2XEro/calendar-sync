...
export default function OrganizationDetailPage() {
	...
	const organizationName =
		query.data?.organization.name ?? decodedSlug ?? fallbackBreadcrumb;
		...
		<section className="mt-8 space-y-4">
			<header>
				...
				<p className="text-muted-foreground text-sm">
					Events published by {organizationName} that you can add to your
					calendar.
				</p>
			</header>
	...
	return (
		<div className="rounded-2xl border border-dashed p-8 text-center">
			...
			<p className="mt-2 text-muted-foreground text-sm">
				{organizationName} hasn’t published any upcoming events yet. Check back
				soon!
			</p>
		</div>
	);
...
function MissingSlugAlert() {
	return (
		<Alert variant="destructive">
			...
			<AlertDescription>
				We couldn’t determine which organization to display. Please return to
				the organizations list and try again.
			</AlertDescription>
		</Alert>
	);
}
