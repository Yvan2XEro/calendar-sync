...
const featureItems = [
  {
    ...
    description: "Automatically surface upcoming events from newsletters and announcements without lifting a finger.",
    icon: "/globe.svg",
  },
  {
    title: "Easy Admin Curation",
    description: "Approve, edit, or reject events in seconds with an intuitive review workflow tailored for busy teams.",
    icon: "/window.svg",
  },
  {
    title: "Google Calendar Sync",
    description: "Push approved events to your personal calendar instantly so you never miss a moment.",
    icon: "/next.svg",
  },
  {
    title: "Weekly Digest",
    description: "Stay informed with curated summaries delivered straight to your inbox each week.",
    icon: "/vercel.svg",
  },
];
    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-900">
      <HeaderNavWrapper>
        <div className="flex flex-1 items-center justify-between py-4">
          <Link
            href="/"
            className="text-xl font-semibold tracking-tight text-[#002147]"
          ...
          <Link
            href="/auth/sign-in"
            className="text-sm font-medium text-[#159BA1] transition hover:text-[#0d6f74]"
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-to-b from-[#002147] via-[#0b2e4f] to-white">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 pb-24 pt-20 md:flex-row md:items-center md:gap-16 lg:px-10">
            <div className="flex-1 space-y-8 text-white">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <Link
                  href="/auth/sign-in"
                  className="inline-flex items-center justify-center rounded-full bg-[#159BA1] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#159BA1]/30 transition hover:bg-[#118189]"
                  style={{ fontFamily: "DM Sans, sans-serif" }}
                >
                  Get Started
                </Link>
              ...
              <div className="relative mx-auto max-w-md rounded-3xl bg-white/10 p-6 shadow-2xl backdrop-blur-lg md:max-w-lg">
                ...
                <div className="relative flex flex-col items-center gap-6 text-center">
                  ...
                  <div className="flex w-full items-center justify-between rounded-2xl bg-white/10 p-4">
                    ...
                    <span className="rounded-full bg-[#F87342] px-4 py-1 text-xs font-semibold text-white">Live</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="features" className="mx-auto w-full max-w-6xl px-6 py-20 lg:px-10">
          <div className="mb-14 text-center">
            <p
              className="text-sm font-semibold uppercase tracking-[0.3em] text-[#159BA1]"
              style={{ fontFamily: "DM Sans, sans-serif" }}
            >
              Platform Highlights
            </p>
            <h2
              className="mt-4 text-3xl font-bold text-[#002147] sm:text-4xl"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {featureItems.map((feature) => (
              ...
              >
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#A0E1DB]/60">
                  <Image src={feature.icon} alt="" width={28} height={28} className="h-7 w-7" />
                </div>
                <div className="space-y-3">
                  <h3
                    className="text-xl font-semibold text-[#002147]"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {feature.title}
                  </h3>
          ...
          <div className="mx-auto w-full max-w-6xl px-6 lg:px-10">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {testimonials.map((testimonial) => (
                ...
                >
                  <p className="text-base text-slate-700" style={{ fontFamily: "DM Sans, sans-serif" }}>
                    “{testimonial.quote}”
                  </p>
        ...
        <section className="mx-auto w-full max-w-4xl px-6 py-20 text-center lg:px-10">
          <div className="rounded-3xl bg-gradient-to-r from-[#002147] via-[#159BA1] to-[#A0E1DB] px-10 py-16 text-white shadow-xl">
            <h2
            ...
            <div className="mt-8 flex justify-center">
              <Link
                href="/auth/sign-in"
                className="inline-flex items-center justify-center rounded-full bg-white px-8 py-3 text-sm font-semibold text-[#002147] shadow-lg transition hover:bg-slate-100"
                style={{ fontFamily: "DM Sans, sans-serif" }}
              >
                Sign Up Now
              </Link>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10 text-sm text-slate-600 md:flex-row md:items-center md:justify-between lg:px-10">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:gap-8">
            <Link href="/privacy" className="hover:text-[#159BA1]" style={{ fontFamily: "DM Sans, sans-serif" }}>
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-[#159BA1]" style={{ fontFamily: "DM Sans, sans-serif" }}>
              Terms of Service
            </Link>
            <Link href="/contact" className="hover:text-[#159BA1]" style={{ fontFamily: "DM Sans, sans-serif" }}>
              Contact
            </Link>
          </div>
          <div className="flex items-center gap-4">
            <Link href="#" className="text-slate-400 transition hover:text-[#159BA1]" aria-label="Twitter">
              <Image src="/globe.svg" alt="" width={20} height={20} className="h-5 w-5" />
            </Link>
            <Link href="#" className="text-slate-400 transition hover:text-[#159BA1]" aria-label="LinkedIn">
              <Image src="/window.svg" alt="" width={20} height={20} className="h-5 w-5" />
            </Link>
            <Link href="#" className="text-slate-400 transition hover:text-[#159BA1]" aria-label="Instagram">
